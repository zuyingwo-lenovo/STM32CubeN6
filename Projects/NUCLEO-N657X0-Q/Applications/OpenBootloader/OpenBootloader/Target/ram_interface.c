...
OPENBL_MemoryTypeDef RAM_FlashLoader_Descriptor =
{
  FLASH_LOADER_START_ADDRESS,
  FLASH_LOADER_END_ADDRESS,
  FLASH_LOADER_SIZE,
  RAM_AREA,
  NULL,
  OPENBL_RAM_Read,
...
void OPENBL_RAM_JumpToAddress(uint32_t Address)
{
  ...
  /* Deinitialize all HW resources used by the Open Bootloader to their reset values */
  OPENBL_DeInit();
